...
this.textContent = "\u2630";
    ...
    console.log("Delva cantik");
    document.getElementById("txtNama").Value = "Delva bukan";
    document.getElementById("txtPesan").Value = "Tinggal di belitung";
});

let nama = prompt("Delva");
alert("Halo, " + nama + "!");
